...
Bfc_st BFC[] = { // standard chains
  ...
  {"pppAMode" ,"" ,"",""                               ,"","","pppAMode is set in StBTofCalibMaker",kFALSE}, // bassam
  {"setPPPAOutlierRej" ,"" ,"",""             ,"","","setPPPAOutlierRej is set in StBTofCalibMaker",kFALSE}, // bassam
  {"vpdPPPAMode" ,"" ,"",""                        ,"","","setting up StVpdCalibMaker for pppAMode",kFALSE}, // bassam
  {"------------","-----------","-----------","------------------------------------------","","","",kFALSE},
